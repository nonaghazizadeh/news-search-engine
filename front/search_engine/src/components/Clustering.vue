...
<div>
  ...
  <div v-if="loading" class="d-flex justify-content-center mb-3">
    ...
    <b-modal id="eval-modal" hide-footer>
        ...
        <p class="mt-4 mb-4 ml-4">Davies Bouldien score: {{DaviesBouldienScore}}</p>
        <p class="mt-4 mb-4 ml-4">Silhouette score: {{SilhouetteScore}}</p>
        <p class="mt-4 mb-4 ml-4">Purity: {{purity}}</p>
    </b-modal>
  </div>
</div>
</template>
